...
export const EVENTS: EventItem[] = [
  // I. Trước 1911 - Nền tảng: gia đình, quê hương, truyền thống dân tộc
  {
    ...
    links: [
      { label: "Hình ảnh: Làng Sen, quê Bác", href: "https://reviewvilla.vn/lang-sen-que-bac/" }
    ],
  },
  ...
  // II. 1911-1920 - “Bác đi tìm đường cứu nước” → Bước ngoặt đến với chủ nghĩa Mác-Lênin
  {
    ...
    media: [{ type: "image", src: "/media/1911-ship.jpg", alt: "Tàu rời Bến Nhà Rồng năm 1911" }],
  ...
  },
  {
    ...
    media: [
      {
        type: "image",
        src: "https://commons.wikimedia.org/wiki/File:Congr%C3%A8s_de_Tours_-_vue_g%C3%A9n%C3%A9rale_de_la_salle.jpg",
        alt: "Quang cảnh Đại hội Tours 1920"
      }
    ],
  },
  ...
  // III. 1921-1923 (Paris): Mở rộng tầm nhìn quốc tế - báo chí cách mạng - “Le Paria”
  {
    ...
    media: [
      {
        type: "image",
        src: "https://en.vietnamplus.vn/Uploaded_EN/ngocltb/2022_08_10/avar_la_paria_1.jpg",
        alt: "Bộ ảnh triển lãm 100 năm Le Paria"
      }
    ],
  },
  ...
  // V. 1924-1927 (Quảng Châu): Tổ chức lực lượng - “Bản án…”, Hội VN CM Thanh niên, “Đường Kách mệnh”
  {
    ...
    links: [
      { label: "“Bản án chế độ thực dân Pháp” (archive)", href: "https://archive.org/details/ban-an-che-do-thuc-dan-phap-nguyen-ai-quoc/" }
    ],
  },
  ...
  // VI. 1928-1930: “Vô sản hóa”, hợp nhất thành ĐCSVN (2/1930)
  {
    ...
    media: [
      {
        type: "image",
        src: "https://banqldtdthanoi.vn/wp-content/uploads/2021/12/1-1.jpg",
        alt: "Nhà 5D Hàm Long - nơi lập Chi bộ Cộng sản đầu tiên (3/1929)"
      }
    ],
  },
